    ...
    <main className="min-h-screen bg-ink text-bg relative overflow-hidden">
      ...
      <div className="relative flex flex-col px-6 pt-6 pb-8 min-h-screen">
        <div className="mt-7 relative">
          ...
          <h1 className="font-display text-[64px] leading-[0.9] -tracking-[1px]">El<br/>Estudio</h1>
        ...
        <form
          ...
          action={(fd) => startForm(async () => {
            ...
            else setMsg({ ok: true, text: 'Te mandamos un link a tu email. Abrilo desde este celu para entrar.' });
          })}
        >
        ...
        <p className="text-center mt-4 text-[11px] text-dark-muted">
          Te enviamos un link a tu email si es tu primera vez.
        </p>
      </div>
    </main>
  );
