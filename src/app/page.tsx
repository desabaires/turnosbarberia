    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 overflow-auto px-5 pb-6">
        ...
        {next ? (
          <div className="bg-ink text-bg rounded-3xl px-5 py-5 mt-1 relative overflow-hidden">
            ...
            <div className="flex gap-2 mt-4">
              <Link href="/mis-turnos" className="flex-1 bg-transparent text-bg border border-dark-line px-3 py-2.5 rounded-m text-[13px] font-medium text-center active:scale-[0.98] transition">Reprogramar</Link>
              <Link href="/mis-turnos" className="flex-1 bg-bg text-ink px-3 py-2.5 rounded-m text-[13px] font-semibold text-center active:scale-[0.98] transition">Ver detalles</Link>
            </div>
          </div>
        ) : (
        ...
        <div className="mt-6 flex items-baseline justify-between">
          ...
          <Link href="/reservar" className="text-xs text-muted active:opacity-60 transition">Ver todos</Link>
        </div>
